...
public class WebSocketManager {
     ...
     *
     * @params ageGroup, username To connect to the server
     */
    public void connectWebSocket(String username, String ageGroup) {
        try {
            String serverUrl = "ws://coms-309-040.class.las.iastate.edu:8080/chat/" + ageGroup + "/" + username;
